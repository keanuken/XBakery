...
public class ViewOrder extends javax.swing.JFrame {
    ...
    ControllerOrders conOrd = new ControllerOrders();
    ...
    public final void getData() {
        ...
        List<Orders> myOrders = conOrd.tampil();
        String[] data = new String[4];
        for (Orders order : myOrders) {
            data[0] = order.getIdOrders();
            data[1] = order.getIdCustomers();
            data[2] = order.getTanggalOrder();
            data[3] = order.getKeterangan();
            dtm.addRow(data);
        }
    }
    ...
    public final void cariData() {
        ...
        List<Orders> myOrders = conOrd.cari(fieldCari.getText());
        String[] data = new String[4];
        for (Orders order : myOrders) {
            data[0] = order.getIdOrders();
            data[1] = order.getIdCustomers();
    ...
    private void initComponents() {
        ...
        cmbCus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "201", "202", "203", "204", "205" }));
        jPanel1.add(cmbCus, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 290, 180, 40));
    ...
    private void btnUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpActionPerformed
        ...
        conOrd.update((fieldID.getText()), (String)cmbCus.getSelectedItem(), ambilTanggal(), fieldKet.getText());
    ...
    private void tableMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMenuMouseClicked
        ...
        cmbCus.setSelectedItem(model.getValueAt(i, 1).toString());
        String cbTO = model.getValueAt(i, 2).toString();
        fieldKet.setText(model.getValueAt(i, 3).toString());
